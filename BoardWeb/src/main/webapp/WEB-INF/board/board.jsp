...
<p>searchCondition: ${sc}, keyword: ${kw}</p>
	<table class="table">
		...
		<tr>
			...
			<c:if test="${!empty board.image}"> <!-- 보드의 이미지가 null값인 경우 보여주지 않는다. -->
		...
		<tr>
			<th>작성일</th><td colspan="3"><fmt:formatDate value="${board.creationDate}" pattern="yyyy.MM.dd HH:mm:ss"/></td>
		</tr>
	</table>
	<!-- 버튼형식 -->
	<div style="text-align: center;">
		<button type="button" class="btn btn-primary ${board.writer ne logid ? 'disabled' : ''}" onclick="form_submit('modifyBoard.do')">수정하기</button> <!-- 디스패처로이동 -->
 	...
 	<div class="container reply">
 	 ...
 	 <!-- 댓글등록 -->
 	 <div class="header">
 	 	<input type="text" id="reply" class="col-sm-6"> <!-- 너비 12등분 중 8을 차지 -->
